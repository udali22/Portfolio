...
export default function App() {
  ...
  const [formStatus, setFormStatus] = useState({ loading: false, success: false, message: '' });
  ...
  const handleContactSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormStatus({ loading: false, success: true, message: data.message || 'Thank you! Your message has been sent.' });
        setFormState({ name: '', email: '', message: '' });
      } else {
        setFormStatus({ loading: false, success: false, message: 'Failed to send message. Please try again or reach out via email.' });
      }
    } catch {
      setFormStatus({ loading: false, success: false, message: 'Network error. Please email directly at maalimohamedalieng@gmail.com' });
    }
  };
  ...
  const defaultProfile = {
    ...
    headline: 'Specialized in backend development and distributed microservices (Spring Boot, Kafka, PostgreSQL), with hands-on experience integrating AI/LLM pipelines into production.',
    summary: 'Software engineer (Engineering Degree, ISIMG Gabès, Sept. 2026, Highest Honors / Mention Très Bien), specialized in backend development, scalable microservices, and AI/LLM production systems.',
  ...
  const defaultExperiences = [
    {
      ...
      description: 'Designed and implemented full-stack microservices platforms and production AI systems for trade compliance and organizational maturity evaluation.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Built the backend and mobile frontend for Louage Tunisie, a shared-taxi transit and trip coordination platform.',
      achievements: [
      ...
      technologies: ['Spring Boot', 'Spring Security', 'Angular', 'Ionic', 'WebSockets', 'MariaDB', 'Agile / Scrum']
    },
    {
      id: 'tunisie-telecom',
      ...
      description: 'Regional telecommunication infrastructure upgrades and fiber network deployment operations.',
      achievements: [
      ...
      technologies: ['Network Infrastructure', 'HUB4 Deployment', 'Fiber Optics', 'Diagnostics']
    }
  ];
  ...
  const defaultProjects = [
    {
      ...
      tagline: 'Collaborative task orchestrator built with .NET 8, EF Core, and SignalR.',
      description: 'Personal project featuring REST API (.NET 8/EF Core, PostgreSQL), ASP.NET Core MVC + KnockoutJS frontend, and real-time bidirectional synchronization via SignalR.',
    ...
    },
    {
      ...
      tagline: 'Angular 17 + FastAPI app generating formal academic emails in French.',
      description: 'Turns concise short intents into formal French academic emails (4 types, 3 formality levels). Features an optional local-LLM execution mode via Ollama and containerized Docker deployment.',
      category: 'AI & NLP',
    ...
    },
    {
      ...
      tagline: 'Speech-to-text AI pipeline cutting physician report writing time by 45%.',
      description: 'Fine-tuned Whisper (self-hosted) for real-time doctor-patient conversation transcription with PyAnnote speaker diarization, and an LLM generating structured summaries to assist doctors (cut report time from 20 to 11 min in tests).',
      category: 'AI & Audio',
      technologies: ['FastAPI', 'Whisper', 'PyAnnote', 'PyTorch', 'Express.js', 'React', 'MySQL'],
    ...
    },
    {
      ...
      tagline: '7-service microservices architecture with 5-stage LangGraph AI pipeline.',
      description: 'Spring Boot 3 + Spring Cloud microservices platform behind API Gateway with Eureka and RS256 JWT auth. Features a 5-stage AI document pipeline in FastAPI using Groq Vision LLM and RapidFuzz AML screening.',
    ...
    },
    {
      ...
      tagline: 'Full-stack platform scoring organizations across 5 dimensions with multi-LLMs.',
      description: 'Provider-agnostic LLM scoring (OpenAI, Claude, Gemini, Groq, OpenRouter) producing structured 1-3 audit scores with confidence levels, Recharts dashboards, audio transcription, and automated PDF reports.',
      category: 'AI & Cloud',
    ...
    },
    {
      ...
      tagline: 'High-performance booking platform with sub-200ms response times.',
      description: 'Node.js/Express REST backend with JWT authentication and responsive Tailwind UI. Achieved a 95% booking success rate and sub-200ms API latency.',
      category: 'Full-Stack Web',
      technologies: ['Node.js', 'Express', 'React', 'Tailwind CSS', 'JWT Auth', 'MongoDB'],
    ...
    },
    {
      ...
      description: 'Spring Boot backend with Spring Security, WebSocket trip tracking, and Angular/Ionic mobile application modeling clients, drivers, trips, and bookings on MariaDB.',
  ...
  const defaultSkills = [
    {
      ...
      description: 'Enterprise APIs, distributed systems, and message-driven architectures',
      skills: ['Spring Boot 3', 'Spring Cloud', 'REST APIs', 'FastAPI', 'Node.js/Express', 'Kafka', 'WebSocket', '.NET 8 / EF Core']
    },
    {
      category: 'Programming Languages',
      description: 'Core languages utilized across backend services and AI pipelines',
    ...
    },
    {
      ...
      description: 'Production LLMs, vision, speech processing, and audio diarization',
      skills: ['LLM Integration (Groq Vision)', 'LangGraph', 'Transformers', 'Whisper Fine-Tuning', 'PyAnnote', 'RapidFuzz']
    },
    {
      category: 'Frontend & Mobile',
      description: 'Modern component-driven web interfaces and cross-platform mobile apps',
      skills: ['React 19 / TypeScript', 'Angular', 'ASP.NET Core MVC', 'Tailwind CSS', 'Ionic']
    },
    {
      category: 'DevOps & Engineering Practices',
      description: 'Containerization, continuous integration, and agile delivery',
  ...
  const defaultEducation = {
    education: [
      ...
      },
      {
        ...
        details: 'Rigorous foundation in advanced mathematics, algorithms, computer architecture, and software design.'
      }
    ],
    certifications: [
      {
  ...
  return (
    <div>
        ...
        <div className="container">
          ...
          <div className="hero-meta-bar">
            ...
            <div className="hero-meta-item">
              ...
              <a href={`mailto:${pData.email}`} style={{ color: 'var(--text-primary)' }}>{pData.email}</a>
            </div>
            <div className="hero-meta-item">
      ...
      <section className="section" id="experience" style={{ backgroundColor: 'rgba(14, 18, 27, 0.4)' }}>
        <div className="container">
          <div className="section-header">
            <span className="section-tag">// CAREER PATH</span>
            <h2 className="section-title">Professional Experience</h2>
            <p className="section-desc">
              Hands-on engineering across enterprise microservices, autonomous AI document pipelines, and real-time distributed platforms.
            </p>
          </div>
              ...
              <div key={exp.id} className="experience-card">
                ...
                <div className="exp-tech-tags">
                  {exp.technologies.map((tech) => (
                    <span key={tech} className="tech-tag" style={{ background: 'rgba(6, 182, 212, 0.06)', borderColor: 'rgba(6, 182, 212, 0.2)', color: '#38bdf8' }}>
                      {tech}
                    </span>
                  ))}
                </div>
      ...
      <section className="section" id="projects">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-desc">
              Production architectures, machine learning workflows, and distributed services.
            </p>
              ...
              {categories.map((cat) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: selectedCategory === cat ? 'var(--accent-cyan)' : 'rgba(255, 255, 255, 0.04)',
                    color: selectedCategory === cat ? '#041017' : 'var(--text-secondary)',
              ...
              <div key={project.id} className="project-card">
                ...
                <div>
                  ...
                  <div className="project-links">
                    {project.github_url && (
                      <a href={project.github_url} target="_blank" rel="noreferrer" className="project-link-btn">
                        {project.github_url.includes('gitlab.com') ? (
                          <Code2 size={15} color="#f97316" />
                        ) : (
                          <Github size={15} />
                        )}
                        <span>{project.github_url.includes('gitlab.com') ? 'GitLab Project' : 'GitHub Repository'}</span>
                        <ArrowUpRight size={13} style={{ opacity: 0.7 }} />
                      </a>
                    )}
                    {project.demo_url && (
                      <a href={project.demo_url} target="_blank" rel="noreferrer" className="project-link-btn" style={{ color: 'var(--accent-cyan)' }}>
      ...
      <section className="section" id="skills" style={{ backgroundColor: 'rgba(14, 18, 27, 0.4)' }}>
        <div className="container">
          <div className="section-header">
            <span className="section-tag">// COMPETENCIES</span>
            <h2 className="section-title">Technical Expertise</h2>
            <p className="section-desc">
              Core technologies utilized across backend microservices, distributed systems, and AI pipelines.
            </p>
          </div>
      ...
      <section className="section" id="education">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-desc">
              Rigorous engineering education at ISIMG Gabès and specialized professional certifications.
            </p>
          </div>
          ...
          {eduData.certifications && eduData.certifications.length > 0 && (
            <div className="cert-card-group">
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                ...
                <h3 style={{ fontSize: '1.15rem' }}>Professional Certifications</h3>
              </div>
      ...
      {/* Contact Section */}
      <section className="section" id="contact" style={{ backgroundColor: 'rgba(14, 18, 27, 0.4)' }}>
        <div className="container">
          <div className="contact-container">
            <div>
              <span className="section-tag">// CONNECT</span>
              <h2 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Let's Discuss Opportunities</h2>
              <p style={{ color: 'var(--text-secondary)', marginBottom: '1.75rem', lineHeight: 1.7 }}>
                Actively seeking a <strong>Junior Backend / Software Engineering role</strong>. 
                Whether you have an open position, an AI or distributed systems project, or would like to discuss my work, feel free to reach out.
              </p>

              <div className="contact-info-list">
                <a href={`mailto:${pData.email}`} className="contact-info-link" title="Send email">
                  <Mail size={18} color="var(--accent-cyan)" />
                  <span>{pData.email}</span>
                </a>
                <a href={`tel:${pData.phone}`} className="contact-info-link" title="Call phone">
            ...
            <form onSubmit={handleContactSubmit} className="contact-form">
              ...
              <button
                ...
                style={{ alignSelf: 'flex-start', opacity: formStatus.loading ? 0.7 : 1 }}
              >
                <Send size={15} />
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div>
            &copy; {new Date().getFullYear()} Mohamed Ali Maali &bull; Junior Software Engineer — Backend
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
            <a href={pData.github_url} target="_blank" rel="noreferrer" style={{ color: 'var(--text-secondary)' }}>GitHub</a>
            <a href={pData.linkedin_url} target="_blank" rel="noreferrer" style={{ color: 'var(--text-secondary)' }}>LinkedIn</a>
            <a href={`mailto:${pData.email}`} style={{ color: 'var(--text-secondary)' }}>Email</a>
          </div>
        </div>
      </footer>
    </div>
